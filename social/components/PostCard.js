    ...
    <Card>
      ...
      <div>
        <p className="my-3 text-sm ">
          ...
          efficitur libero. Maecenas aliquam eros id mauris interdum tincidunt.
          Ut placerat rhoncus justo, faucibus euismod ex gravida at. Duis ligula
          felis, fermentum id lobortis et, sodales pretium justo
        </p>
        <div className="rounded-md overflow-hidden">
          <img
            src="https://images.unsplash.com/photo-1519112232436-9923c6ba3d26?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"
            alt=""
          />
        </div>
      </div>
