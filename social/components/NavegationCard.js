...
export default function NavegationCard() {
  ...
  const nonActiveElementClasses =
    "text-sm md:text-md flex md:gap-1 md:gap-3 py-2 my-2 hover:bg-blue-500 hover:bg-opacity-20 md:-mx-4 px-6 md:px-4  rounded-md transition-all hover:scale-110 hover:shadow-md shadow-gray-300";
